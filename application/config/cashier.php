...
*/
$config['redirect_url'] = '/payment-success'; // relative to index.php
...
$config['razorpay'] = array(
    'enabled' => true,
    'keyId' => system_settings('keyId'),
    'keySecret' => system_settings('keySecret'),
    'webhookSecret' => '!se9J9PUn#LzN3Z',
    'merchantName' => system_settings('site_title'),
    'merchantLogoPath' => system_settings('company_logo') // relative to index.php
);
