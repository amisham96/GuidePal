    ...
    <section class="main-pd-wrapper" style=" margin: auto;background: antiquewhite;">
      <div style="
                ...
                <p style="text-align: left;">
                    <b>Invoice No. :</b> <?=$subscription_payment['order_id']?> 
                </p>
              ...
              <table style="width: 100%; table-layout: fixed">
                ...
                <tbody>
                  <tr class="invoice-items">
                    <td>01.</td>
                    <td><?=$subscription_payment['pkg_name']?> Package</td>
                    <td><?=$subscription_payment['duration']?> Months</td>
                    <td style="text-align: right;"><?=system_settings('currency_sign')?> <?=$subscription_payment['order_amount']?></td>
                  </tr>
                </tbody>
              </table>
              ...
              border-radius: 4px;">
                <thead>
                  <tr>
                    ...
                    <th>&nbsp;</th>
                    <th style="text-align: right;"><?=system_settings('currency_sign')?> <?=$subscription_payment['order_amount']?></th>
                  </tr>
                </thead>
