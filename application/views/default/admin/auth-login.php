...
<head>
        ...
        <meta content="Guide Pal" name="description" />
                            ...
                            <div class="w-100">
                                <div class="d-flex flex-column h-100">
                                    <div class="mb-4 mb-md-5 text-center">
                                        <a href="<?=base_url()?>admin/Auth/login" class="d-block auth-logo">
                                            <!--<img src="<?=base_url()?>uploads/logo.png" alt="" width="100%" height="100%"> <span class="logo-txt"></span>-->
                                            <h1 style="padding-top:30px">Guide Pal</h1>
                                        </a>
                                    </div>
                                            ...
                                            <div class="mb-3">
                                                <div class="d-flex align-items-start">
                                                    ...
                                                    <div class="flex-shrink-0">
                                                        <div class="">
                                                            <a href="<?php echo base_url('/admin/Auth/forgot_password'); ?>" class="text-forgot">Forgot password?</a>
                                                        </div>
                                                    </div>
                                                </div>
