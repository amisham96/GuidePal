								...
								<div class="page-title-box d-sm-flex align-items-center justify-content-between">
									...
									<div class="page-title-right">
										<ol class="breadcrumb m-0">
											...
											<li class="breadcrumb-item active">View Rent as a Friend</li>
										</ol>
									</div>
											...
											<div class="row">
											    <div class="col-xl-12 col-md-12">
												  <div class="row">    
													...
													<div class="form-group mb-3 col-md-9">
													  <?php if($view_rent_friend['photo']){ ?>  
													   <img src="<?php echo base_url($view_rent_friend['photo']); ?>" width="60" height="60">
													  <?php }else{ ?>
												...
												<div class="col-xl-12 col-md-12">
												   <div class="row">
												      <div class="form-group mb-3 col-md-3">
													   ...
													   <div class="form-group mb-3 col-md-9">
													    <?php echo $view_rent_friend['name']; ?> 
													   </div> 
												   </div>
												</div>
												<div class="col-xl-12 col-md-12">
												   <div class="row">
												      <div class="form-group mb-3 col-md-3">
													   ...
													   <div class="form-group mb-3 col-md-9">
													    <?php echo $view_rent_friend['email']; ?> 
													   </div> 
												   </div>
												</div>
												<div class="col-xl-12 col-md-12">
												   <div class="row">
												      <div class="form-group mb-3 col-md-3">
													   ...
													   <div class="form-group mb-3 col-md-9">
													    <?php echo $view_rent_friend['phone']; ?> 
													   </div> 
												   </div>
												</div>
												<div class="col-xl-12 col-md-12">
												  ...
												  <div class="row">
													...
													<div class="form-group mb-3 col-md-9">
													    <?php foreach($country as $row){ ?>
                                                         <span><?php if($view_rent_friend['country'] == $row['id']){ echo $row['name'];}?></span>
                                                         <?php } ?> 
													</div>
												  </div>
												</div>
												  ...
												  <div class="row">
													...
													<div class="form-group mb-3 col-md-9">
													    <?php 
                                                         ...
                                                         <span><?php if($view_rent_friend['state'] == $row->id){ echo $row->name;}?></span>
                                                         <?php } ?> 
													</div>
												  </div>
												</div>
												<div class="col-xl-12 col-md-12">
												   <div class="row">
												      <div class="form-group mb-3 col-md-3">
													   ...
													   <div class="form-group mb-3 col-md-9">
													    <?php echo $view_rent_friend['city']; ?> 
													   </div> 
												   </div>
												</div>
												<div class="col-xl-12 col-md-12">
												  <div class="row">    
													...
													<div class="form-group mb-3 col-md-9">
													  <?php echo $view_rent_friend['address']; ?>
													</div>
												  </div>	
												</div>
												<div class="col-xl-12 col-md-12">
												  <div class="row">    
													...
													<div class="form-group mb-3 col-md-9">
													  <?php echo $view_rent_friend['aadhar_num']; ?>
													</div>
												  </div>	
												</div>
												<div class="col-xl-12 col-md-12">
												  <div class="row">    
													...
													<div class="form-group mb-3 col-md-9">
													  <img src="<?php echo base_url($view_rent_friend['aadhar_image']); ?>" width="60" height="60">
													</div>
												  </div>	
												</div>
												<div class="col-xl-12 col-md-12">
												  <div class="row">    
													...
													<div class="form-group mb-3 col-md-9">
													  <?php 
													  if($friend_images){
													  foreach($friend_images as $images){ ?>  
							                    ...
							                    <div class="col-xl-12 col-md-12">
												  <div class="row">
													...
													<div class="form-group mb-3 col-md-9">
													    <?php if($view_rent_friend['status']==1) {
													        echo "Enabled"; 
													     }
													     else{
													         echo "Disabled";
