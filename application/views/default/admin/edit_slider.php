											...
											<div class="row">
												<div class="col-xl-12 col-md-12">
													<div class="form-group mb-3">
														...
														<input type="text"  name="title" class="form-control" placeholder="Slider title" value="<?php echo addslashes($slider['title']); ?>" />
													</div>
												</div>
												<div class="col-xl-12 col-md-12">
													<div class="form-group mb-3">
														<label>Slider tagline</label>
														<input type="text"  name="tagline" class="form-control" placeholder="Enter tagline" value="<?php echo addslashes($slider['tagline']); ?>" />
													</div>
												</div>
												<div class="col-xl-12 col-md-12">
													<div class="form-group mb-3">
														<label>Related Event</label>
														<select class="form-control" name="related_event" required>
															<option value="">Select</option>
															<?php foreach($events as $event){ ?>
															<option value="<?php echo $event['id'] ?>" <?php echo ($event['id'] == $slider['related_event']) ? 'selected' : ''; ?>><?php echo $event['event_name'] ?></option>
															<?php } ?>
														</select>
													</div>
												</div>
