								...
								<div class="page-title-box d-sm-flex align-items-center justify-content-between">
									...
									<div class="page-title-right">
										<ol class="breadcrumb m-0">
											...
											<li class="breadcrumb-item active">View User Registration</li>
										</ol>
									</div>
											...
											<div class="row">
												   ...
												   <div class="row">
												      <div class="form-group mb-3 col-md-3">
													   ...
													   <div class="form-group mb-3 col-md-9">
													    <?php echo $view_user_register['name']; ?> 
													   </div> 
												   </div>
												</div>
												<div class="col-xl-12 col-md-12">
												   <div class="row">
												      <div class="form-group mb-3 col-md-3">
													   ...
													   <div class="form-group mb-3 col-md-9">
													    <?php echo $view_user_register['email']; ?> 
													   </div> 
												   </div>
												</div>
												<div class="col-xl-12 col-md-12">
												   <div class="row">
												      <div class="form-group mb-3 col-md-3">
													   ...
													   <div class="form-group mb-3 col-md-9">
													    <?php echo $view_user_register['phone']; ?> 
													   </div> 
												   </div>
												</div>
												<div class="col-xl-12 col-md-12">
												   <div class="row">
												      <div class="form-group mb-3 col-md-3">
													   ...
													   <div class="form-group mb-3 col-md-9">
													    <?php echo $view_user_register['dob']; ?> 
													   </div> 
												   </div>
												</div>
												<div class="col-xl-12 col-md-12">
												  <div class="row">
													...
													<div class="form-group mb-3 col-md-9">
													    <?php foreach($country as $row){ ?>
                                                         <span><?php if($view_user_register['country'] == $row['id']){ echo $row['name'];}?></span>
                                                         <?php } ?> 
													</div>
												  </div>
												</div>
												  ...
												  <div class="row">
													...
													<div class="form-group mb-3 col-md-9">
													    <?php 
                                                         ...
                                                         <span><?php if($view_user_register['state'] == $row->id){ echo $row->name;}?></span>
                                                         <?php } ?> 
													</div>
												  </div>
												</div>
												<div class="col-xl-12 col-md-12">
												   <div class="row">
												      <div class="form-group mb-3 col-md-3">
													   ...
													   <div class="form-group mb-3 col-md-9">
													    <?php echo $view_user_register['city']; ?> 
													   </div> 
												   </div>
												</div>
												<div class="col-xl-12 col-md-12">
												  <div class="row">    
													...
													<div class="form-group mb-3 col-md-9">
													  <?php echo $view_user_register['address']; ?>
													</div>
												  </div>	
												</div>
												<!--<div class="col-xl-12 col-md-12">
												  <div class="row">    
													...
													<div class="form-group mb-3 col-md-9">
													  <?php echo $view_user_register['aadhar_num']; ?>
													</div>
												  </div>	
												</div>
												<div class="col-xl-12 col-md-12">
												  <div class="row">    
													...
													<div class="form-group mb-3 col-md-9">
													  <img src="<?php echo base_url($view_user_register['aadhar_image']); ?>" width="60" height="60">
													</div>
												  </div>	
												</div>-->
							                    ...
							                    <div class="col-xl-12 col-md-12">
												  <div class="row">
													...
													<div class="form-group mb-3 col-md-9">
													    <?php if($view_user_register['status']==1) {
													        echo "Enabled"; 
													     }
													     else{
													         echo "Disabled";
