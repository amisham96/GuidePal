    ...
    <div class="row">
       <div class="col-lg-12 col-md-12">
         ...
         <div class="profile-form-wrapper">
          <form action="<?=base_url()?>friend-profile" method="post" enctype="multipart/form-data">
           ...
           <div class="form-group">
              <label>Age</label>
              <input type="text" class="my-form-control" name="age" id="friendage" value="<?php echo $profile['age'];?>" placeholder="Enter Your Age">
           </div>
           <div class="form-group">
              <label>Country</label>
		   ...
		   <div class="form-group mb-3">
			...
			<div class="col-xl-12 col-md-12">
													<div class="form-group mb-3">
														...
														<?php
													     $friend_image=$this->db->get_where('friend_gallery_img',['friend_id' => $profile['id']])->result_array();
