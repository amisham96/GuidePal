		...
		<div class="container">
			<div class="section__wrapper">
			  <div class="row g-0 wow fadeInUp" data-wow-duration="1.5s">
			   <?php foreach($rent_friend_details as $details){ ?>     
				<div class="col-lg-12 col-md-12 col-12">    
				 <div class="img_area">
				  <div class="backlink">
				    <a href="<?=base_url()?>rent-as-a-friend">   
				   ...
				   <div class="details__slider overflow-hidden">
					 <div class="swiper-wrapper">
					   <?php
				         $first_img = $this->db->get_where('rent_friend', array('id' => $friend_first_img['id']))->row_array();
				        ?>
					   ...
					   <?php
						...
						<div class="swiper-slide">
							<div class="details__thumb">
							  <img src="<?=base_url()?><?=$images['images'];?>" alt="dating thumb">
							</div>
						</div>
						<?php } }else {?>
						<div class="swiper-slide">
							<div class="details__thumb">
							  <img src="<?=base_url()?>uploads/static/placeholder.png" alt="dating thumb">
							</div>
						</div>
						<?php } ?>
					  </div>
				   ...
				   <div class="info_wrap">
				     ...
				     <div class="right_area">
				      <a href="javascript:void(0)" onclick="friendStarRate('<?=$details['id']?>')">     
				       <div class="item">
...
<!-- Star Rating Modal -->
	<div class="modal fade rating_modal" id="friendStarRating" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
