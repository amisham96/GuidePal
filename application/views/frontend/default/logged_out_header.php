		...
		<div class="header__bottom">
			<div class="container">
				<nav class="navbar navbar-expand-lg">
					<a class="navbar-brand" href="<?=base_url()?>"><h2 style="color:#fff">Guidepal</h2><!--<img src="assets/images/" alt="logo">--></a>
					<div class="header__more">
                            ...
                            <ul class="dropdown-menu" aria-labelledby="moreoption">
                                <li><a class="dropdown-item" href="<?=base_url()?>letsconnect">User Login</a></li>
                                <li><a class="dropdown-item" href="<?=base_url()?>login">Guide Login</a></li>
                            </ul>
					</div>
